...
parser.add_argument("--elmo", type=boolean_string, default=False, help="if True, use elmo embeddings")
...
parser.add_argument("--src_task", default="ontonotes_ner", help="specify the source task")
parser.add_argument("--tgt_task", default="conll03_en_ner", help="specify the target task")
